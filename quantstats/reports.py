...
def html(
    ...
    **kwargs
    ...
    figfile = _utils._file_stream()
    _plots.daily_heatmap(
        returns,
        grayscale=False,  # Force dark theme
        figsize=(16, 10),
        cbar=True,
        title="Daily Returns",
        savefig={"fname": figfile, "format": figfmt},
    ...
    tpl = tpl.replace("{{daily_heatmap}}", _embed_figure(figfile, figfmt))
    ...
    tpl = tpl.replace("{{monthly_bars}}", _embed_figure(figfile, figfmt))
...
_METRIC_DEFINITIONS = {
    ...
    "Period": "Total number of trading days in the period",
    "Start Period": "Start date of the analysis period",
    "End Period": "End date of the analysis period",
    "Risk-Free Rate": "Risk-free rate used for calculations",
    "Time in Market": "Percentage of time the strategy was invested",
    "Cumulative Return": "Total return over the entire period",
    "CAGR%": "Compound Annual Growth Rate - annualized return",
    "Sharpe": "Risk-adjusted return measure (excess return per unit of volatility)",
    "Smart Sharpe": "Sharpe ratio adjusted for non-normal return distributions",
    "Sortino": "Downside risk-adjusted return measure",
    "Smart Sortino": "Sortino ratio adjusted for non-normal return distributions",
    "Sortino/√2": "Sortino ratio divided by square root of 2",
    "Prob. Sharpe Ratio": "Probability that the Sharpe ratio is greater than a benchmark",
    "Smart Sortino/√2": "Smart Sortino ratio divided by square root of 2",
    "Omega": "Probability-weighted ratio of gains to losses",
    "Max Drawdown": "Largest peak-to-trough decline in portfolio value",
    "Max Drawdown Duration": "Longest period of consecutive drawdown",
    "Avg Drawdown": "Average drawdown during losing periods",
    "Avg Drawdown Duration": "Average length of drawdown periods",
    "Recovery Factor": "Cumulative return divided by maximum drawdown",
    "Calmar": "CAGR divided by maximum drawdown",
    "Skewness": "Measure of return distribution asymmetry",
    "Kurtosis": "Measure of return distribution tail heaviness",
    "Expected Daily": "Expected daily return based on historical data",
    "Expected Monthly": "Expected monthly return based on historical data",
    "Expected Yearly": "Expected yearly return based on historical data",
    ...
    "Daily Value-at-Risk": "Maximum expected daily loss at 95% confidence",
    "Expected Shortfall (cVaR)": "Average loss beyond Value-at-Risk threshold",
    "Max Consecutive Wins": "Longest streak of positive returns",
    "Max Consecutive Losses": "Longest streak of negative returns",
    "Gain/Pain Ratio": "Sum of gains divided by sum of losses",
    "Gain/Pain (1M)": "Gain/pain ratio over 1-month periods",
    "Best Day": "Best single day return",
    "Worst Day": "Worst single day return",
    "Best Month": "Best single month return", 
    "Worst Month": "Worst single month return",
    "Best Year": "Best single year return",
    "Worst Year": "Worst single year return",
    "Avg. Drawdown": "Average drawdown during losing periods",
    "Avg. Drawdown Duration": "Average length of drawdown periods",
    "Avg. Up Month": "Average return during positive months",
    "Avg. Down Month": "Average return during negative months",
    ...
    "Correlation": "Linear relationship with benchmark returns",
    "Treynor Ratio": "Excess return per unit of systematic risk",
    "Information Ratio": "Excess return per unit of tracking error",
    "Volatility (ann.)": "Annualized standard deviation of returns",
    "R²": "Proportion of variance explained by benchmark",
    "Common Sense Ratio": "CAGR divided by average drawdown",
    "CPC Index": "Calmar-Performance-Consistency index",
    "Tail Ratio": "Ratio of 95th to 5th percentile returns",
    "Outlier Win Ratio": "Ratio of outlier wins to total wins",
    "Outlier Loss Ratio": "Ratio of outlier losses to total losses",
    "MTD": "Month-to-date return",
    "3M": "3-month return",
    "6M": "6-month return", 
    "YTD": "Year-to-date return",
    "1Y": "1-year return",
    "3Y (ann.)": "3-year annualized return",
    "5Y (ann.)": "5-year annualized return",
    "10Y (ann.)": "10-year annualized return",
    "All-time (ann.)": "All-time annualized return",
    "Avg. Drawdown %": "Average drawdown as percentage",
    "Max. Drawdown %": "Maximum drawdown as percentage",
    "Max. Drawdown Duration": "Longest drawdown period in days",
    "Avg. Drawdown Duration": "Average drawdown period in days",
    "Recovery Factor": "Cumulative return divided by max drawdown",
    "Ulcer Index": "Measure of drawdown severity and duration",
    "Serenity Index": "Risk-adjusted return considering drawdowns",
...
def _html_table(obj, showindex="default"):
    """
    Convert DataFrame to HTML table format for report generation with tooltips.
    ...
    and cleans up spacing for better presentation. Metric names in the first column
    get tooltips with definitions.
    ...
    -------
    str
        HTML string containing the formatted table with tooltips
    ...
    # Add tooltips to metric names in the first column
    import re
    for metric_name, definition in _METRIC_DEFINITIONS.items():
        # Create tooltip HTML for metric names
        tooltip_html = f'<span class="metric-tooltip" title="{definition}">{metric_name}</span>'
        # Use regex to handle various spacing and formatting variations
        pattern = rf'<td>\s*{re.escape(metric_name)}\s*</td>'
        obj = re.sub(pattern, f'<td>{tooltip_html}</td>', obj)
