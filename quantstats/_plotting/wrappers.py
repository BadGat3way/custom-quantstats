...
def daily_heatmap(
    ...
    """
    Wrapper to plot a daily returns heatmap with enhanced visualization.
    """
    if prepare_returns:
        returns = _utils._prepare_returns(returns)
    return _core.plot_daily_heatmap(
        returns,
        grayscale=grayscale,
        figsize=figsize,
        fontname=fontname,
...
def monthly_bars(
    ...
    """
    Wrapper to plot monthly returns bars with month-year labels.
    """
    if prepare_returns:
        returns = _utils._prepare_returns(returns)
    return _core.plot_monthly_bars(
        returns,
        compounded=compounded,
        grayscale=grayscale,
        figsize=figsize,
